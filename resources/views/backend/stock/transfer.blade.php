    ...
    <section class="section">
      <h3>Transfer Report</h3>
        <div class="section-body">
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                          ...
                          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                <form action="{{route('transfer.filter')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-3">
            ...
            @if(count($transfer_lists)>0)
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                          @if (isset($from_dateJunk))
                          <h4 class="text-center">Transfer Products List from:{{ $from_dateJunk }} to {{ $to_dateJunk }}</h4>
                          @else
                             <h4 class="text-center"> All Transfer Products List:</h4>
                          @endif
                                ...
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                      @php
                                          ...
                                          $price=0;
                                      @endphp
                                      @foreach ($transfer_lists as $item)
                                      <tr>
                                        <td>{{ $loop->index+1 }}</td>
                                        <td>{{ $item->date }}</td>
                                        <td>{{ $item->code }}</td>
