    ...
    <section class="section">
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <form action="{{ route('stock.wh_transfer_update') }}" method="POST">
                        @csrf
                        <div class="input-group input-group-sm mb-3">
                            <div class="input-group-prepend">
                              <span class="input-group-text" id="inputGroup-sizing-sm">Enter Warehouse Qty: </span>
                            </div>
                            <input type="text" name="sr_qty" class="form-control" value="{{ $stock->sr_qty }}" aria-describedby="inputGroup-sizing-sm">
                            <input type="hidden" name="stock_id" class="form-control" value="{{ $stock->id }}">
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            
                            <button type="submit" class="form-control btn btn-warning">Transfer showroom  to wirehouse</button>
                        </div>
                    </form>
                </div>
            </div>
