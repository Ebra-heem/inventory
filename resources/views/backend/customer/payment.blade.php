                ...
                <div class="col-12">
                    <div class="card">
                         @if (count($customers)>0) 
                            <form action="{{ route('customer.paymentList') }}" method="POST">
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                        <td class="badge badge-danger"><a href="{{url('/invoice-delivery',$invoice->id)}}" onclick="return confirm('Do you want to complete status?')">Pending</a></td>
                                        @endif
