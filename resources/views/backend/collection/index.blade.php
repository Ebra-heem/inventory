            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <a href="{{route('collection.create')}}" class="btn btn-success">+ Add Collection</a>
                        </div>
                        @if(count($incomes))
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <td>{{$income->collection_date}}</td>
                                        @php
                                        $company= \App\Vendor::where('id',$income->vendor_id)->first();
                                        @endphp
                                        <td>{{$company->company_name}}</td>
                                        <td>{{$income->amount}}</td>
                                        <td>{{$income->note}}</td>
                                        <td>{{$income->payment_type==1?'Cash':'Bank'}}</td>
