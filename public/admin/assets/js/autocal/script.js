...
Invoice.prototype = {
    ...
    newRow: function () {
        ...
        jQuery(".item-row:last")
        .after('<tr class="item-row"><td class="item-name"><div class="delete-btn"><select name="product_id[]" class="item" id="item"><?php echo fill_unit_select_box();?></select><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div></td><td><input class="form-control price" placeholder="Price" type="text"> </td><td><input name="bag[]" class="form-control bag" placeholder="No of bags" type="text"> </td><td><input class="form-control qty" placeholder="Quantity" type="text"></td><td><span class="total">0.00</span></td></tr>');
